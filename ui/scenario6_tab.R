...
conditionalPanel(
  condition = "input.level == 6",

  bsCollapse(
    id = "collapse_panel_sc6",
    multiple = TRUE,
    open = c(
      "General Parameters"
...
bsCollapsePanel("Eligibility Criteria",
                ...
                wellPanel(fluidRow(
                  ...
                  column(
                    ...
                    ,
                    sliderInput(
                      "frequency_eligibility_slider_sc6",
                  ...
                  column(
                    4,
                    switchInput(
                      "invite_known_hypertensives_checkbox_sc6",
                    ...
                    br(),
                    switchInput(
                      "invite_known_diabetics_checkbox_sc6",
  ...
  wellPanel(
    fluidRow(
      ...
      column(
        ...
        br(),
        switchInput(
          "coverage_detailed_checkbox_sc6",
          "Detailed input",
          value = FALSE,
          onLabel = "Show",
          offLabel = "Hide",
...
bsCollapsePanel("Health Checks Received (%)",
                ...
                wellPanel(
                  ...
                  fluidRow(
                    br(),
                    uiOutput("uptake_table_help_sc6"),
                    tableOutput("uptake_table_sc6"),
                    switchInput(
                      "uptake_structural_zeroes_sc6",
...
#   wellPanel(
#     fluidRow(
#     uiOutput("statin_px_table_help_sc6"),
#     tableOutput("statin_px_table_sc6")
# )),

# wellPanel(
#   fluidRow(
#     uiOutput("antihtn_px_table_help_sc6"),
#     tableOutput("antihtn_px_table_sc6")
#   ))
),
...
fluidRow(
    column(6,
           switchInput(
             "parallel_ensemble_checkbox_sc6",
  ...
  #   column(3,
  #          switchInput(
  #            "ignore_cholesterol_checkbox_sc6",
  ...
  wellPanel(fluidRow(
    ...
    column(6,
      ...
      checkboxGroupButtons("qimd_risk_factors_checkbox_sc6",
...
wellPanel(
  ...
  fluidRow( 
         column(2, 
                numericInput(
                  "smoking_initiation_qimd1_textbox_sc6",
  ...
  column(2, 
         numericInput(
           "smoking_initiation_qimd2_textbox_sc6",
  ...
  column(2, 
         numericInput(
           "smoking_initiation_qimd3_textbox_sc6",
  ...
  column(2, 
         numericInput(
           "smoking_initiation_qimd4_textbox_sc6",
  ...
  column(2, 
         numericInput(
           "smoking_initiation_qimd5_textbox_sc6",
  ...
  fluidRow( 
    column(2, 
           numericInput(
             "smoking_cessation_qimd1_textbox_sc6",
    ...
    column(2, 
           numericInput(
             "smoking_cessation_qimd2_textbox_sc6",
    ...
    column(2, 
           numericInput(
             "smoking_cessation_qimd3_textbox_sc6",
    ...
    column(2, 
           numericInput(
             "smoking_cessation_qimd4_textbox_sc6",
    ...
    column(2, 
           numericInput(
             "smoking_cessation_qimd5_textbox_sc6",
...
fluidRow( 
  column(2, 
         numericInput(
           "smoking_relapse_qimd1_textbox_sc6",
  ...
  column(2, 
         numericInput(
           "smoking_relapse_qimd2_textbox_sc6",
  ...
  column(2, 
         numericInput(
           "smoking_relapse_qimd3_textbox_sc6",
  ...
  column(2, 
         numericInput(
           "smoking_relapse_qimd4_textbox_sc6",
  ...
  column(2, 
         numericInput(
           "smoking_relapse_qimd5_textbox_sc6",
...
conditionalPanel(condition = "input.level == input.scenarios_number_slider",
                 fluidRow(
                   br(),
                   bsAlert("alert_locality_sc6"),
                   br(),
                   bsAlert("alert_baseline_sc6"),
                   br(),
                   actionButton(
                     "run_simulation_sc6",
