...
wellPanel(
  ...
  column(2, 
         ...
         column(2, 
                numericInput(
                  "smoking_prevalence_slider_qimd1_sc6",
  ...
  column(2, 
         numericInput(
           "smoking_prevalence_slider_qimd2_sc6",
  ...
  column(2, 
         numericInput(
           "smoking_prevalence_slider_qimd3_sc6",
  ...
  column(2, 
         numericInput(
           "smoking_prevalence_slider_qimd4_sc6",
  ...
  column(2, 
         numericInput(
           "smoking_prevalence_slider_qimd5_sc6",
