...
bsCollapsePanel(
  ...
  wellPanel(fluidRow(
    ...
    column(
      ...
      div(uiOutput("init_year_slider_sc5"))
...
bsCollapsePanel(
  ...
  #               4,
  #               sliderInput(
  #                 "lifestyle_attrition_slider_sc5",
...
fluidRow(
  ...
  wellPanel(fluidRow(
    ...
    column(6,
           ...
           # ,
           # # sliderInput(
           # #   "structural_neversmk_slider_sc5",
  ...
  wellPanel(fluidRow(
    ...
    column(6,
      ...
      checkboxGroupButtons("qimd_risk_factors_checkbox_sc5",
...
wellPanel(
  ...
  fluidRow( 
         column(2, 
                numericInput(
                  "smoking_initiation_qimd1_textbox_sc5",
  ...
  column(2, 
         numericInput(
           "smoking_initiation_qimd2_textbox_sc5",
  ...
  column(2, 
         numericInput(
           "smoking_initiation_qimd3_textbox_sc5",
  ...
  column(2, 
         numericInput(
           "smoking_initiation_qimd4_textbox_sc5",
  ...
  column(2, 
         numericInput(
           "smoking_initiation_qimd5_textbox_sc5",
  ...
  fluidRow( 
    column(2, 
           numericInput(
             "smoking_cessation_qimd1_textbox_sc5",
    ...
    column(2, 
           numericInput(
             "smoking_cessation_qimd2_textbox_sc5",
    ...
    column(2, 
           numericInput(
             "smoking_cessation_qimd3_textbox_sc5",
    ...
    column(2, 
           numericInput(
             "smoking_cessation_qimd4_textbox_sc5",
    ...
    column(2, 
           numericInput(
             "smoking_cessation_qimd5_textbox_sc5",
...
fluidRow( 
  column(2, 
         numericInput(
           "smoking_relapse_qimd1_textbox_sc5",
  ...
  column(2, 
         numericInput(
           "smoking_relapse_qimd2_textbox_sc5",
  ...
  column(2, 
         numericInput(
           "smoking_relapse_qimd3_textbox_sc5",
  ...
  column(2, 
         numericInput(
           "smoking_relapse_qimd4_textbox_sc5",
  ...
  column(2, 
         numericInput(
           "smoking_relapse_qimd5_textbox_sc5",
...
conditionalPanel(condition = "input.level == input.scenarios_number_slider",
                 fluidRow(
                   br(),
                   bsAlert("alert_locality_sc5"),
                   br(),
                   bsAlert("alert_baseline_sc5"),
                   br(),
                   actionButton(
                     "run_simulation_sc5",
