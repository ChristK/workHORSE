...
bsCollapsePanel(
  ...
  wellPanel(fluidRow(
    ...
    column(
      ...
      div(uiOutput("init_year_slider_sc1"))
...
fluidRow(
  ...
  wellPanel(fluidRow(
    ...
    column(6,
           ...
           # ,
           # # sliderInput(
           # #   "structural_neversmk_slider_sc1",
  ...
  wellPanel(fluidRow(
    ...
    column(6,
      ...
      checkboxGroupButtons("qimd_risk_factors_checkbox_sc1",
...
wellPanel(
  ...
  fluidRow( 
         column(2, 
                numericInput(
                  "smoking_initiation_qimd1_textbox_sc1",
  ...
  column(2, 
         numericInput(
           "smoking_initiation_qimd2_textbox_sc1",
  ...
  column(2, 
         numericInput(
           "smoking_initiation_qimd3_textbox_sc1",
  ...
  column(2, 
         numericInput(
           "smoking_initiation_qimd4_textbox_sc1",
  ...
  column(2, 
         numericInput(
           "smoking_initiation_qimd5_textbox_sc1",
  ...
  fluidRow( 
    column(2, 
           numericInput(
             "smoking_cessation_qimd1_textbox_sc1",
    ...
    column(2, 
           numericInput(
             "smoking_cessation_qimd2_textbox_sc1",
    ...
    column(2, 
           numericInput(
             "smoking_cessation_qimd3_textbox_sc1",
    ...
    column(2, 
           numericInput(
             "smoking_cessation_qimd4_textbox_sc1",
    ...
    column(2, 
           numericInput(
             "smoking_cessation_qimd5_textbox_sc1",
...
fluidRow( 
  column(2, 
         numericInput(
           "smoking_relapse_qimd1_textbox_sc1",
  ...
  column(2, 
         numericInput(
           "smoking_relapse_qimd2_textbox_sc1",
  ...
  column(2, 
         numericInput(
           "smoking_relapse_qimd3_textbox_sc1",
  ...
  column(2, 
         numericInput(
           "smoking_relapse_qimd4_textbox_sc1",
  ...
  column(2, 
         numericInput(
           "smoking_relapse_qimd5_textbox_sc1",
...
conditionalPanel(condition = "input.level == input.scenarios_number_slider",
                 fluidRow(
                   br(),
                   bsAlert("alert_locality_sc1"),
                   br(),
                   bsAlert("alert_baseline_sc1"),
                   br(),
                   actionButton(
                     "run_simulation_sc1",
