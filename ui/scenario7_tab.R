...
conditionalPanel(
  condition = "input.level == 7",

  bsCollapse(
    id = "collapse_panel_sc7",
    multiple = TRUE,
    open = c(
      "General Parameters"
...
bsCollapsePanel(
  ...
  wellPanel(fluidRow(
    ...
    column(
      ...
      div(
      textInput("friendly_name_sc7", "Friendly name", "Scenario 7")
      %>%
    ...
    column(
      ...
      div(uiOutput("init_year_slider_sc7"))
...
bsCollapsePanel("Eligibility Criteria",
                ...
                wellPanel(fluidRow(
                  ...
                  column(
                    ...
                    ,
                    sliderInput(
                      "frequency_eligibility_slider_sc7",
                  ...
                  column(
                    4,
                    switchInput(
                      "invite_known_hypertensives_checkbox_sc7",
                    ...
                    br(),
                    switchInput(
                      "invite_known_diabetics_checkbox_sc7",
  ...
  wellPanel(
    fluidRow(
      ...
      column(
        ...
        br(),
        switchInput(
          "coverage_detailed_checkbox_sc7",
          "Detailed input",
          value = FALSE,
          onLabel = "Show",
          offLabel = "Hide",
...
bsCollapsePanel("Health Checks Received (%)",
                ...
                wellPanel(
                  ...
                  fluidRow(
                    br(),
                    uiOutput("uptake_table_help_sc7"),
                    tableOutput("uptake_table_sc7"),
                    switchInput(
                      "uptake_structural_zeroes_sc7",
...
fluidRow(
    column(6,
           switchInput(
             "parallel_ensemble_checkbox_sc7",
...
wellPanel(
  ...
  fluidRow( 
         column(2, 
                numericInput(
                  "smoking_initiation_qimd1_textbox_sc7",
  ...
  column(2, 
         numericInput(
           "smoking_initiation_qimd2_textbox_sc7",
  ...
  column(2, 
         numericInput(
           "smoking_initiation_qimd3_textbox_sc7",
  ...
  column(2, 
         numericInput(
           "smoking_initiation_qimd4_textbox_sc7",
  ...
  column(2, 
         numericInput(
           "smoking_initiation_qimd5_textbox_sc7",
  ...
  fluidRow( 
    column(2, 
           numericInput(
             "smoking_cessation_qimd1_textbox_sc7",
    ...
    column(2, 
           numericInput(
             "smoking_cessation_qimd2_textbox_sc7",
    ...
    column(2, 
           numericInput(
             "smoking_cessation_qimd3_textbox_sc7",
    ...
    column(2, 
           numericInput(
             "smoking_cessation_qimd4_textbox_sc7",
    ...
    column(2, 
           numericInput(
             "smoking_cessation_qimd5_textbox_sc7",
...
fluidRow( 
  column(2, 
         numericInput(
           "smoking_relapse_qimd1_textbox_sc7",
  ...
  column(2, 
         numericInput(
           "smoking_relapse_qimd2_textbox_sc7",
  ...
  column(2, 
         numericInput(
           "smoking_relapse_qimd3_textbox_sc7",
  ...
  column(2, 
         numericInput(
           "smoking_relapse_qimd4_textbox_sc7",
  ...
  column(2, 
         numericInput(
           "smoking_relapse_qimd5_textbox_sc7",
...
conditionalPanel(condition = "input.level == input.scenarios_number_slider",
                 fluidRow(
                   br(),
                   bsAlert("alert_locality_sc7"),
                   br(),
                   bsAlert("alert_baseline_sc7"),
                   br(),
                   actionButton(
                     "run_simulation_sc7",
