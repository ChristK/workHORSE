...
wellPanel(
  ...
  column(2, 
         ...
         column(2, 
                numericInput(
                  "smoking_prevalence_slider_qimd1_sc2",
  ...
  column(2, 
         numericInput(
           "smoking_prevalence_slider_qimd2_sc2",
  ...
  column(2, 
         numericInput(
           "smoking_prevalence_slider_qimd3_sc2",
  ...
  column(2, 
         numericInput(
           "smoking_prevalence_slider_qimd4_sc2",
  ...
  column(2, 
         numericInput(
           "smoking_prevalence_slider_qimd5_sc2",
